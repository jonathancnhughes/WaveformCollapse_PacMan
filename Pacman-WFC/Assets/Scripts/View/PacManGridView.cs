...
namespace JFlex.PacmanWFC.View
{
    public class PacManGridView : MonoBehaviour
    {
        ...
        public void CreateCells(int height, int width, SpritePartMapping spritePartMapping)
        {
            ...
            gridContainer = new GameObject("GridRoot");
            ...
            for (var y = 0; y < height; y++)
            {
                for (var x = 0; x < width; x++)
                {
                    ...
                    targetGroup.AddMember(cellObj.transform, 1, 1);
                }
            }
        }
        ...
        public void ResetCells(CellGrid<CellObj> cellGrid)
        {
            for (var y = 0; y < height; y++)
            {
                for (var x = 0; x < width; x++)
        ...
        public void RefreshCell(CellObj cell)
        {
            var x = cell.X;
            var y = cell.Y;
